...
function autoloader( $resource = '' ) {
	$resource_path  = false;
	$namespace_root = 'Wordpress_Starter\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( WORDPRESS_STARTER_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Wordpress_Starter\Inc\Helpers\autoloader' );